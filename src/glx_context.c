                              ...
                              )
{
    ...
    GLXContext share = sharedCtx;

/**
 * We deleted the following part because it sets up the shared opengl context
 * with another glfw window. We don't want this since 
 * we manage the context by ourselves
 */
//     if (ctxconfig->share)
